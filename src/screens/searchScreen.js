      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => onProvincePress(item)}>
            <View style={[styles.provinceItem, selectedProvince === item.id && styles.selectedProvinceItem]}>
              <Text style={[styles.provinceName, selectedProvince === item.id && styles.selectedProvinceName]}>{item.name}</Text>
            </View>
          </TouchableOpacity>
        )}
